...
class TeamManagement extends Component {
    ...
    handleTeamSelect = (event) => {
        ...
        const selectedTeam = this.props.teams.find((t) => t.id === selectedTeamId)
        if (selectedTeam) {
            const selectedTeamPlayers = Object.values(selectedTeam.players).filter(Boolean)
                ...
                <div className="grid-container">
                    ...
                    <div className="grid-body">
                        {sortedPlayers.map((player) => (
                            <div key={player.player_id} className="grid-row">
